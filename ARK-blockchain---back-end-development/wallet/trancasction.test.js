    ...
    describe('update()', () => {
        ...
        describe('and the amount is invalid', () => {
            it('throws an error', () => {
                expect(() => {
                    transaction.update({
                        senderWallet, recipient: "arkGEN", amount: 999999
                    })
        ...
        describe('and the amount is valid', () => {
            beforeEach(() => {
                ...
                originalSignature = transaction.outputMap[senderWallet.publicKey];
                nextAmount = 50;
            });
        ...
        it('re-signa the transaction', () => {
            expect(transaction.input.signature).noy.toEqual(originalSignature);
        });
